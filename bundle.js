...
var Pico = function () {
	...
	this.start = function(audiofile){
		...
		var cost = inputMic(state); //ここで帰ってきてない
		console.log(cost);
		return cost;
	}
...
function init(audiofile, state){
	...
	state.maxframe = 6;//Math.ceil(audio.duration/state.duration); //ここなおす
	return state;
...
},{"./lib/dtw":11}],6:[function(require,module,exports){
...
},{"./Pico":5}],7:[function(require,module,exports){
...
},{"./comparison":7,"./distanceFunctions/euclidean":8,"./distanceFunctions/manhattan":9,"./distanceFunctions/squaredEuclidean":10,"./matrix":12,"./validate":13,"debug":2}],12:[function(require,module,exports){
